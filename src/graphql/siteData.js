...
export const siteContent = {
  ...
  about: {
    ...
    portrait: "/between_the_waters/3.jpg",
    body: {
      en: [
        "Ivaylo Bozhinov works on photographic series where observation, place, and human presence are central. His projects gather scenes from everyday life, peripheral spaces, and moments in which the environment speaks as strongly as the people within it.",
        "This website is arranged as a personal archive: each series has its own address, a dedicated gallery, and a way to be shared.",
      ],
      bg: [
        "Ивайло Божинов работи по фотографски серии, в които наблюдението, мястото и човешкото присъствие са водещи. Проектите му събират сцени от ежедневието, периферни пространства и моменти, в които средата разказва толкова, колкото и хората в нея.",
        "Този сайт е подреден като личен архив: всяка серия има собствен адрес, самостоятелна галерия и възможност за споделяне.",
      ],
    },
  },
  contact: {
