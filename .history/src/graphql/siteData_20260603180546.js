  ...
  about: {
    ...
    body: {
      en: [
        ...
        "I am also part of the team behind Phodar Biennial, the international photographic salon held in Sofia, where I have worked both as a co-organizer and as a jury member.",
      ],
      bg: [
        ...
        "Също така съм част от екипа на Phodar Biennial — международния фотографски салон, който се провежда в София, където съм работил както като съорганизатор, така и като член на жури.",
      ],
    },
  },
  contact: {
